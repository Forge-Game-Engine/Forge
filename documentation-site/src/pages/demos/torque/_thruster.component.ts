 ...
 * queries for this alongside the entity's `RigidBodyEcsComponent` and calls
 * `applyTorque` directly while `holdAction` is held. There's no
 * engine-provided "apply this torque" component for this, since real game
...
export const thrusterId = createComponentId<ThrusterEcsComponent>('thruster');
