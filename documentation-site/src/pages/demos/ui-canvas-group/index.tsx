...
export default function UiCanvasGroup(): JSX.Element {
  ...
  return (
    <Demo
      ...
      blurb="A single CanvasGroupEcsComponent lives on the outer modal panel. Toggling 'Disable modal' fades and disables everything under it in one write - the nested card, its label, its long description, and its 'Confirm' button - two and three levels down in the tree. createUiCanvasGroupEcsSystem walks the whole subtree, not just direct children, so alpha/interactable/blocksRaycasts propagate arbitrarily deep. The toggle itself lives outside the group, so it stays fully opaque and clickable the whole time."
