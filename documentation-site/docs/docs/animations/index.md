...
:::note
Animations are data-driven: add animation-related components to entities and register the corresponding animation systems on the `EcsWorld` to have them updated each tick.
:::
