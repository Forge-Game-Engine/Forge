...
function scanExact(target, xRange, yRange, minRunPerRow, label) {
  ...
  if (rowCounts.length===0){ console.log(label,'no rows'); return null;}
...
console.log('--- MUTE row (y 0-90) ---');
scanExact([255,255,255], [0,130], [0,90], 1, 'MUTE caption text');
scanExact([217,217,224], [130,180], [0,90], 5, 'MUTE checkbox');
