...
describe('smoothDamp Vector2', () => {
  it('returns target position and zero velocity when already at target', () => {
    const position = createVector2(1, 2);
    const target = createVector2(1, 2);
    const velocity = createVector2(0, 0);
    const maxSpeed = 10;
  ...
  it('moves position closer to target', () => {
    const position = createVector2(0, 0);
    const target = createVector2(10, 0);
    const velocity = createVector2(0, 0);
    const maxSpeed = 100;
    const smoothTime = 0.5;
    const deltaTime = 0.016;
  ...
  it('limits movement by maxSpeed', () => {
    const position = createVector2(0, 0);
    const target = createVector2(1000, 0);
    const velocity = createVector2(0, 0);
    const maxSpeed = 1;
    const smoothTime = 0.5;
    const deltaTime = 0.016;
  ...
  it('handles negative velocity', () => {
    const position = createVector2(10, 0);
    const target = createVector2(0, 0);
  ...
  it('does not overshoot the target', () => {
    const position = createVector2(0, 0);
    const target = createVector2(1, 0);
    const velocity = createVector2(1000, 0);
    const maxSpeed = 1000;
